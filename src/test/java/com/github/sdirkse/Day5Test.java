...
class Day5Test {
    ...
    private final Day5 riddle = new Day5();
    private final FileResourceUtil fileResourceUtil = new FileResourceUtil();
    private final String input = fileResourceUtil.readFile("day5.txt");

    @Test
    void testPartOne() {
        long result = riddle.partOne(input);

        assertEquals(4790, result);
    }
    ...
    void testEndlessLoopInput() {
        String input = """
                ...
                31,99,79,11,43,39,42,34,32,77,52,72,93
                """;
