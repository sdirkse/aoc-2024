...
class Day15Test {
    ...
    private final Day15 riddle = new Day15();
    private final FileResourceUtil fileResourceUtil = new FileResourceUtil();
    private final String input = fileResourceUtil.readFile("day15.txt");

    @Test
    void testPartOne() {
        long result = riddle.partOne(input);

        assertEquals(1438161, result);
    }
